...
VL_MODULE(Vadam_riscv) {
  public:
    ...
    VL_SIG8(adam_riscv__DOT__id_func3_code,2,0);
    ...
    VL_SIG8(adam_riscv__DOT__id_matrix_index,1,0);
    VL_SIG8(adam_riscv__DOT__id_mem2matrix,0,0);
    VL_SIG8(adam_riscv__DOT__id_matrix_write,0,0);
    VL_SIG8(adam_riscv__DOT__id_matrix_write_mopa,0,0);
    VL_SIG8(adam_riscv__DOT__id_mem_matrix2reg,1,0);
    VL_SIG8(adam_riscv__DOT__id_mem_reg2matrix,0,0);
    VL_SIG8(adam_riscv__DOT__id_matrix2mem,0,0);
    ...
    VL_SIG8(adam_riscv__DOT__ex_matrix_index,1,0);
    VL_SIG8(adam_riscv__DOT__ex_mem2matrix,0,0);
    VL_SIG8(adam_riscv__DOT__ex_matrix_write,0,0);
    VL_SIG8(adam_riscv__DOT__ex_matrix_write_mopa,0,0);
    VL_SIG8(adam_riscv__DOT__ex_mem_matrix2reg,1,0);
    VL_SIG8(adam_riscv__DOT__ex_mem_reg2matrix,0,0);
    VL_SIG8(adam_riscv__DOT__ex_matrix2mem,0,0);
    ...
    VL_SIG8(adam_riscv__DOT__me_matrix_index,1,0);
    VL_SIG8(adam_riscv__DOT__me_mem2matrix,0,0);
    VL_SIG8(adam_riscv__DOT__me_matrix_write,0,0);
    VL_SIG8(adam_riscv__DOT__me_matrix_write_mopa,0,0);
    VL_SIG8(adam_riscv__DOT__me_mem_matrix2reg,1,0);
    VL_SIG8(adam_riscv__DOT__me_mem_reg2matrix,0,0);
    VL_SIG8(adam_riscv__DOT__me_matrix2mem,0,0);
    VL_SIG8(adam_riscv__DOT__wb_mem2reg,0,0);
    VL_SIG8(adam_riscv__DOT__wb_matrix_index,1,0);
    VL_SIG8(adam_riscv__DOT__wb_mem2matrix,0,0);
    VL_SIG8(adam_riscv__DOT__wb_matrix_write,0,0);
    VL_SIG8(adam_riscv__DOT__wb_matrix_write_mopa,0,0);
    VL_SIG8(adam_riscv__DOT__wb_mem_matrix2reg,1,0);
    VL_SIG8(adam_riscv__DOT__wb_mem_reg2matrix,0,0);
    ...
    VL_SIG8(adam_riscv__DOT__u_stage_id__DOT__mem_write,0,0);
    ...
    VL_SIG(adam_riscv__DOT__ex_inst,31,0);
    VL_SIG(adam_riscv__DOT__ex_matrix_line_data,31,0);
    VL_SIG(adam_riscv__DOT__me_regs_data2,31,0);
    VL_SIG(adam_riscv__DOT__me_alu_o,31,0);
    VL_SIG(adam_riscv__DOT__me_mem_data,31,0);
    VL_SIG(adam_riscv__DOT__me_inst,31,0);
    VL_SIG(adam_riscv__DOT__me_matrix_line_data,31,0);
    VL_SIG(adam_riscv__DOT__me_regs_data1,31,0);
    VL_SIG(adam_riscv__DOT__wb_mem_data,31,0);
    VL_SIG(adam_riscv__DOT__wb_alu_o,31,0);
    VL_SIG(adam_riscv__DOT__wb_matrix_line_data,31,0);
    VL_SIG(adam_riscv__DOT__wb_regs_data1,31,0);
    VL_SIG(adam_riscv__DOT__wb_inst,31,0);
    ...
    VL_SIG(adam_riscv__DOT__u_stage_ex__DOT__u_matrix_mul__DOT__matrix_line_0,31,0);
    VL_SIG(adam_riscv__DOT__u_stage_ex__DOT__u_matrix_mul__DOT__matrix_line_1,31,0);
    VL_SIG(adam_riscv__DOT__u_stage_ex__DOT__u_matrix_mul__DOT__matrix_line_2,31,0);
    VL_SIG(adam_riscv__DOT__u_stage_ex__DOT__u_matrix_mul__DOT__matrix_line_3,31,0);
    VL_SIG(adam_riscv__DOT__u_stage_mem__DOT__w_data_mem,31,0);
    VL_SIG(adam_riscv__DOT__u_stage_mem__DOT__r_data_mem,31,0);
    VL_SIG(adam_riscv__DOT__w_matrix_data_mopa[4],31,0);
    VL_SIG(adam_riscv__DOT__id_M[4],31,0);
    VL_SIG(adam_riscv__DOT__ex_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT__ex_M[4],31,0);
    VL_SIG(adam_riscv__DOT__me_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT__wb_matrix_mul_o[4],31,0);
    VL_SIG8(adam_riscv__DOT__u_stage_if__DOT__inst_memory__DOT__inst[1024],7,0);
    VL_SIG(adam_riscv__DOT__u_stage_id__DOT__u_matrix__DOT__M[4],31,0);
    ...
    VL_SIG8(adam_riscv__DOT____Vtogcov__id_func3_code,2,0);
    ...
    VL_SIG8(adam_riscv__DOT____Vtogcov__id_matrix_index,1,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__id_mem2matrix,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__id_matrix_write,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__id_matrix_write_mopa,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__id_mem_matrix2reg,1,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__id_mem_reg2matrix,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__id_matrix2mem,0,0);
    ...
    VL_SIG8(adam_riscv__DOT____Vtogcov__ex_matrix_index,1,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__ex_mem2matrix,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__ex_matrix_write,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__ex_matrix_write_mopa,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__ex_mem_matrix2reg,1,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__ex_mem_reg2matrix,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__ex_matrix2mem,0,0);
    ...
    VL_SIG8(adam_riscv__DOT____Vtogcov__me_matrix_index,1,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__me_mem2matrix,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__me_matrix_write,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__me_matrix_write_mopa,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__me_mem_matrix2reg,1,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__me_mem_reg2matrix,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__me_matrix2mem,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__forward_data,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__wb_mem2reg,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__wb_matrix_index,1,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__wb_mem2matrix,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__wb_matrix_write,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__wb_matrix_write_mopa,0,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__wb_mem_matrix2reg,1,0);
    VL_SIG8(adam_riscv__DOT____Vtogcov__wb_mem_reg2matrix,0,0);
    ...
    VL_SIG(adam_riscv__DOT____Vtogcov__w_matrix_data,31,0);
    ...
    VL_SIG(adam_riscv__DOT____Vtogcov__id_matrix_line_data,31,0);
    ...
    VL_SIG(adam_riscv__DOT____Vtogcov__ex_inst,31,0);
    VL_SIG(adam_riscv__DOT____Vtogcov__ex_matrix_line_data,31,0);
    ...
    VL_SIG(adam_riscv__DOT____Vtogcov__me_inst,31,0);
    VL_SIG(adam_riscv__DOT____Vtogcov__me_matrix_line_data,31,0);
    VL_SIG(adam_riscv__DOT____Vtogcov__me_regs_data1,31,0);
    VL_SIG(adam_riscv__DOT____Vtogcov__wb_mem_data,31,0);
    VL_SIG(adam_riscv__DOT____Vtogcov__wb_alu_o,31,0);
    VL_SIG(adam_riscv__DOT____Vtogcov__wb_matrix_line_data,31,0);
    VL_SIG(adam_riscv__DOT____Vtogcov__wb_regs_data1,31,0);
    VL_SIG(adam_riscv__DOT____Vtogcov__wb_inst,31,0);
    ...
    VL_SIG(adam_riscv__DOT__u_stage_ex__DOT__u_matrix_mul__DOT____Vtogcov__matrix_line_0,31,0);
    VL_SIG(adam_riscv__DOT__u_stage_ex__DOT__u_matrix_mul__DOT____Vtogcov__matrix_line_1,31,0);
    VL_SIG(adam_riscv__DOT__u_stage_ex__DOT__u_matrix_mul__DOT____Vtogcov__matrix_line_2,31,0);
    VL_SIG(adam_riscv__DOT__u_stage_ex__DOT__u_matrix_mul__DOT____Vtogcov__matrix_line_3,31,0);
    ...
    VL_SIG(adam_riscv__DOT____Vcellout__u_stage_id__id_M[4],31,0);
    VL_SIG(adam_riscv__DOT____Vcellinp__u_stage_id__w_matrix_data_mopa[4],31,0);
    VL_SIG(adam_riscv__DOT____Vcellout__u_reg_id_ex__ex_M[4],31,0);
    VL_SIG(adam_riscv__DOT____Vcellinp__u_reg_id_ex__id_M[4],31,0);
    VL_SIG(adam_riscv__DOT____Vcellout__u_stage_ex__ex_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT____Vcellinp__u_stage_ex__ex_M[4],31,0);
    VL_SIG(adam_riscv__DOT____Vcellout__u_reg_ex_mem__me_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT____Vcellinp__u_reg_ex_mem__ex_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT____Vcellout__u_reg_mem_wb__wb_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT____Vcellinp__u_reg_mem_wb__me_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT____Vcellout__u_stage_wb__w_matrix_data_mopa[4],31,0);
    VL_SIG(adam_riscv__DOT____Vcellinp__u_stage_wb__wb_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT____Vtogcov__w_matrix_data_mopa[4],31,0);
    VL_SIG(adam_riscv__DOT____Vtogcov__id_M[4],31,0);
    VL_SIG(adam_riscv__DOT____Vtogcov__ex_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT____Vtogcov__ex_M[4],31,0);
    VL_SIG(adam_riscv__DOT____Vtogcov__me_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT____Vtogcov__wb_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT__u_stage_id__DOT____Vcellout__u_matrix__M_out[4],31,0);
    VL_SIG(adam_riscv__DOT__u_stage_id__DOT____Vcellinp__u_matrix__w_matrix_data_mopa[4],31,0);
    VL_SIG(adam_riscv__DOT__u_stage_id__DOT____Vtogcov__w_matrix_data_mopa[4],31,0);
    VL_SIG(adam_riscv__DOT__u_stage_id__DOT____Vtogcov__id_M[4],31,0);
    VL_SIG(adam_riscv__DOT__u_stage_id__DOT__u_matrix__DOT____Vtogcov__w_matrix_data_mopa[4],31,0);
    VL_SIG(adam_riscv__DOT__u_stage_id__DOT__u_matrix__DOT____Vtogcov__M_out[4],31,0);
    VL_SIG(adam_riscv__DOT__u_stage_id__DOT__u_matrix__DOT____Vtogcov__M[4],31,0);
    VL_SIG(adam_riscv__DOT__u_reg_id_ex__DOT____Vtogcov__id_M[4],31,0);
    VL_SIG(adam_riscv__DOT__u_reg_id_ex__DOT____Vtogcov__ex_M[4],31,0);
    VL_SIG(adam_riscv__DOT__u_stage_ex__DOT____Vcellout__u_matrix_mul__matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT__u_stage_ex__DOT____Vcellinp__u_matrix_mul__M[4],31,0);
    VL_SIG(adam_riscv__DOT__u_stage_ex__DOT____Vtogcov__ex_M[4],31,0);
    VL_SIG(adam_riscv__DOT__u_stage_ex__DOT____Vtogcov__ex_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT__u_stage_ex__DOT__u_matrix_mul__DOT____Vtogcov__M[4],31,0);
    VL_SIG(adam_riscv__DOT__u_stage_ex__DOT__u_matrix_mul__DOT____Vtogcov__matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT__u_reg_ex_mem__DOT____Vtogcov__ex_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT__u_reg_ex_mem__DOT____Vtogcov__me_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT__u_reg_mem_wb__DOT____Vtogcov__me_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT__u_reg_mem_wb__DOT____Vtogcov__wb_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT__u_stage_wb__DOT____Vtogcov__wb_matrix_mul_o[4],31,0);
    VL_SIG(adam_riscv__DOT__u_stage_wb__DOT____Vtogcov__w_matrix_data_mopa[4],31,0);
